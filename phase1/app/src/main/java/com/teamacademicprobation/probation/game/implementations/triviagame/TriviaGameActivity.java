...
public class TriviaGameActivity extends AppCompatActivity implements TriviaView {
  ...
  /**
   * 1. Set up the layout of the screen 2. Set the local variables to the corresponding UI elements
   * 3. Construct a new TriviaGamePresenter instance 4. Updates the UI with the first question and
   * answers.
   *
  ...
  /**
   * Evaluate whether the answerClicked is correct and update the score accordingly, then grab the
   * next question.
   *
  ...
  /**
   * When all questions have been answered, head to the results screen. The intent sent to the
   * results screen contains the message to be displayed.
   *
