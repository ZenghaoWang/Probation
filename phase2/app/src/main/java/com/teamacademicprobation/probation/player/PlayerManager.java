...
public class PlayerManager
     ...
     * Sets the data file.
     *
     * @param dataFile The file where data should be saved.
     */
     ...
     * @param save True if the player wants to save the score into total and best game.
     */
    @Override
     ...
     * @return String of the logged in playerID.
     */
     ...
     * @return A map where the keys are statIDs and the values are the stats.
     */
    @Override
     ...
     * @return A map where the keys are the statIDs and the values are the keys.
     */
    @Override
