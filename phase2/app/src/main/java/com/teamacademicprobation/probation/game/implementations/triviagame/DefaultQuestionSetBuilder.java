...
/**
 * The default set of questions for the trivia game. To create a new set of questions, extend
 * QuestionSet.
 */
class DefaultQuestionSetBuilder extends QuestionSetBuilder {

  DefaultQuestionSetBuilder() {
    super();
  }
