...
public class PowerUpSelect implements Drawable {
    ...
    private void generateImages() {
        increaseDamage = BitmapFactory.decodeResource(context.getResources(), R.drawable.damage_upgrade);
    ...
    public List<AndroidDrawer> getDrawers() {
        ...
        int length = SIZE +150;
        DamageBoostDrawer dmDrawer = new DamageBoostDrawer(increaseDamage, damageX, y, generateTextPaint());
        HealthBoostDrawer hbDrawer = new HealthBoostDrawer(increaseHealth, healthX, y, generateTextPaint());
        PowerUpLineDrawer pulDrawer = new PowerUpLineDrawer((int)(screenWidth*0.5), (int)(screenHeight*0.5-(length*0.5)), length, generateTextPaint());
